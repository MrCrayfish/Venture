...
public class Venture
{
    ...
    private void onCommonSetup(FMLCommonSetupEvent event)
    {
        ...
        Biome.BIOMES.forEach(biome -> biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, ModFeatures.HUGE_ORE.get().func_225566_b_(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, Blocks.IRON_ORE.getDefaultState(), 50)).func_227228_a_(Placement.COUNT_DEPTH_AVERAGE.func_227446_a_(new DepthAverageConfig(1, 24, 4)))));
    }
}
