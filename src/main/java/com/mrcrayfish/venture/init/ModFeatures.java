...
public class ModFeatures
{
    ...
    public static final RegistryObject<SurvivalCampStructure> SURVIVAL_CAMP = REGISTER.register("survival_camp", () -> new SurvivalCampStructure(SurvivalCampConfig::deserialize));
